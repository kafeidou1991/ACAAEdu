...
-(NSMutableAttributedString*)labelStytle:(NSInteger)value{
    ...
    [pace1 addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:35] range:NSMakeRange(0, pace.length-1)];
    [pace1 addAttribute:NSFontAttributeName value:[UIFont boldSystemFontOfSize:15] range:NSMakeRange(pace.length-1, 1)];
    NSRange titleRange = NSMakeRange(0, pace.length);
    [pace1 addAttribute:NSForegroundColorAttributeName
                  value:[self colorWithHexString:@"#F9A74E"]
                  range:titleRange];
    return pace1;
}
- (void)NameLbChange{
...
- (UILabel *)numbLb {
    if(_numbLb == nil) {
        ...
        _numbLb.font = [UIFont boldSystemFontOfSize:35];
        _numbLb.text = @"0";
...
- (CAShapeLayer *)backgroundLine {
    if(_backgroundLine == nil) {
        ...
        _backgroundLine.strokeColor = [self colorWithHexString:@"e5e5e5"].CGColor;
...
- (CAShapeLayer *)mainLine {
    if(_mainLine == nil) {
        ...
        _mainLine.strokeColor = [self colorWithHexString:@"1DCFC2"].CGColor;
...
//        [_grain setColors:[NSArray arrayWithObjects:
//                           (id)[[self colorWithHexString:@"1DCFC2"] CGColor], nil]];
        
        _grain.backgroundColor = [[self colorWithHexString:@"1DCFC2"]CGColor];
